...
public class main {
  ...
  public static void main(String[] args) {
    Affordability affordability = new Affordability(800000, RateType.STANDARD, Terms.SHORT_TERM, "Chase Bank");
    System.out.println(affordability.getAffordabilityAmount());
//    CommonVariables variables = new CommonVariables(500000, 80000, 100, 200, 50, "USAA" ,Terms.LONG_TERM, RateType.STANDARD);
